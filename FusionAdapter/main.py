...
if __name__ == '__main__':
    ...
    print('loading text and image embedding ... ...')
    dataset['visual2emb'] = np.load(data_dir['fb_visual'])
    dataset['text2emb'] = np.load(data_dir['fb_ling'])
    dataset['struc2emb'] = np.load(data_dir['fb_struc'])
    print("----------------------------")
